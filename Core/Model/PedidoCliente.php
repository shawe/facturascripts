...
use FacturaScripts\Dinamic\Model\LineaPedidoCliente as DLineaPedidoCliente;
...
class PedidoCliente extends Base\SalesDocument
{
     ...
     *
     * @return DLineaPedidoCliente[]
     */
    public function getLines(): array
    {
        $lineaModel = new DLineaPedidoCliente();
     ...
     * @return DLineaPedidoCliente
     */
    public function getNewLine(array $data = []): DLineaPedidoCliente
    {
        $newLine = new DLineaPedidoCliente($data);
